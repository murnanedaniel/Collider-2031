...
export default function MetacollaborationDashboard() {
    ...
    const otherMetacollaborations = [
        { name: 'ExoticSearch M.C.', members: 892, focus: 'BSM particles' },
        { name: 'Precision M.C.', members: 654, focus: 'SM measurements' },
        { name: 'Neutrino M.C.', members: 431, focus: 'Neutrino physics' },
        { name: 'DarkMatter M.C.', members: 1043, focus: 'DM searches' },
    ];

    return (
        <ScreenLayout
            title="HiLumi Metacollaboration"
            subtitle="Distributed anomaly detection across HL-LHC experiments"
        >
            <div className="space-y-8">
                ...
                <Card className="border-l-4 border-blue-500">
                    <h3 className="text-xl font-light mb-3">About HiLumi M.C.</h3>
                    <p className="text-sm text-gray-700 leading-relaxed mb-4">
                        The HiLumi Metacollaboration focuses on model-independent anomaly detection across
                        ATLAS, CMS, LHCb, and ALICE experiments. By combining hit-level open data from all
                        detectors with Foundation Space embeddings, we enable cross-experiment searches for
                        new physics without traditional analysis-specific triggers.
                    </p>
                    <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                            <div className="text-gray-600 text-xs mb-1">Founded</div>
                            <div className="font-medium">May 2029</div>
                        </div>
                        <div>
                            <div className="text-gray-600 text-xs mb-1">Primary Detector</div>
                            <div className="font-medium">ATLAS + CMS</div>
                        </div>
                        <div>
                            <div className="text-gray-600 text-xs mb-1">Key Technology</div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded text-sm transition-colors ${filterRegion === 'all'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded text-sm transition-colors ${filterRegion === 'nearby'
                                ? 'bg-gray-900 text-white'
                                : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                            }`}
                    >
                    ...
                    {memberHeatmapState.filterApplied && (
                        <button
                            ...
                            className={`px-4 py-2 rounded text-sm transition-colors animate-fade-in ${filterRegion === 'angular'
                                    ? 'bg-gray-900 text-white'
                                    : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                }`}
                        >
                ...
                {/* Other Metacollaborations */}
                <Card>
                    <h3 className="text-lg font-medium mb-4">Other Metacollaborations</h3>
                    <p className="text-sm text-gray-600 mb-4 italic">
                        Links not yet functional - these are placeholder examples
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                        {otherMetacollaborations.map((mc) => (
                            <div
                                key={mc.name}
                                className="p-4 border border-gray-200 rounded hover:border-gray-300 cursor-not-allowed opacity-60"
                            >
                                <div className="font-medium mb-1">{mc.name}</div>
                                <div className="text-sm text-gray-600">{mc.focus}</div>
                                <div className="text-xs text-gray-500 mt-2">{mc.members} members</div>
                            </div>
                        ))}
                    </div>
                </Card>
                ...
                <div className="flex justify-between pt-6">
                    ...
                    <Link to={ROUTES.MEMBERS}>
                        <button className="btn-secondary">View Full Member Heatmap →</button>
                    </Link>
                </div>
            </div>
        </ScreenLayout>
